...
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "yt-db", table_name = "raw_statistics", transformation_ctx = "datasource0", push_down_predicate = predicate_pushdown)
...
# This converts to a Spark DataFrame, reduces partitions to 1, and converts back to a DynamicFrame
datasink_df = applymapping1.toDF().coalesce(1)
...
datasink4 = glueContext.write_dynamic_frame.from_options(
    ...
    format="glueparquet", 
    connection_options={
        "path": "s3://bucket-cleaned-useast-1-dev/youtube/raw_statistics/", 
